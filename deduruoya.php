        ...
        <div class="cot">
            <div class="img">
                ...
                if (!empty($image_name['image_1'])) {
                    echo '<a href="javascript:void(0)"><img src="uploads/deduruoya/' . htmlspecialchars($image_name['image_1']) . '" alt=""></a>';
                }
                ?>
            </div>
        ...
        <div class="cot">
            <div class="img">
                ...
                if (!empty($image_name['image_2'])) {
                    echo '<a href="javascript:void(0)"><img src="uploads/deduruoya/' . htmlspecialchars($image_name['image_2']) . '" alt=""></a>';
                }
                ?>
            </div>
        ...
        <div class="cot">
            <div class="img">
                ...
                if (!empty($image_name['image_3'])) {
                    echo '<a href="javascript:void(0)"><img src="uploads/deduruoya/' . htmlspecialchars($image_name['image_3']) . '" alt=""></a>';
                }
                ?>
            </div>
        ...
        <div class="cot">
            <div class="img">
                ...
                if (!empty($image_name['image_4'])) {
                    echo '<a href="javascript:void(0)"><img src="uploads/deduruoya/' . htmlspecialchars($image_name['image_4']) . '" alt=""></a>';
                }
                ?>
            </div>
